...
void SolidColorShader::Initialize(D3DGraphics& gfx)
{
	InitializeShaders(gfx, L"Shaders/SolidColorVS.cso", L"Shaders/SolidColorPS.cso");
}

void SolidColorShader::Bind(D3DGraphics& gfx, int indexCount, XMMATRIX world, XMMATRIX view, XMMATRIX projection)
{
	// 월드, 뷰, 투영 행렬 설정해줌.
...
void SolidColorShader::InitializeShaders(D3DGraphics& gfx, const std::wstring& vsFileName, const std::wstring& psFileName)
{
	INFOMAN(gfx);
...
void SolidColorShader::SetShaderParameters(D3DGraphics& gfx, XMMATRIX world, XMMATRIX view, XMMATRIX projection)
{
...
void SolidColorShader::BindShaders(D3DGraphics& gfx, int indexCount)
{
	// 정점 입력 레이아웃을 바인딩 해줌.
