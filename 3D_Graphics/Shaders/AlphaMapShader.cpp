...
void AlphaMapShader::Initialize(D3DGraphics& gfx, HWND hwnd)
{
	InitializeShaders(gfx, hwnd, L"Shaders/AlphaMapVS.cso", L"Shaders/AlphaMapPS.cso");
}

void AlphaMapShader::Bind(D3DGraphics& gfx, int indexCount, XMMATRIX world, XMMATRIX view, XMMATRIX projection, ID3D11ShaderResourceView** textureArray)
{
	// 월드, 뷰, 투영 행렬 설정해줌.
...
void AlphaMapShader::InitializeShaders(D3DGraphics& gfx, HWND hwnd, const std::wstring& vsFileName, const std::wstring& psFileName)
{
	INFOMAN(gfx);
...
void AlphaMapShader::SetShaderParameters(D3DGraphics& gfx, XMMATRIX world, XMMATRIX view, XMMATRIX projection, ID3D11ShaderResourceView** textureArray)
{
...
void AlphaMapShader::BindShader(D3DGraphics& gfx, int indexCount)
{
	// 정점 입력 레이아웃을 바인딩 해줌.
