...
{
	SetShaderParameters(gfx, world, view, projection, diffuse, lightDir, textureArray);

	BindShader(gfx, indexCount);
}

void NormalMapShader::InitializeShaders(D3DGraphics& gfx, const std::wstring& vsFileName, const std::wstring& psFileName)
{
	INFOMAN(gfx);
...
void NormalMapShader::SetShaderParameters(D3DGraphics& gfx, XMMATRIX world, XMMATRIX view, XMMATRIX projection, XMFLOAT4 diffuse, XMFLOAT3 lightDir, ID3D11ShaderResourceView** textureArray)
{
...
void NormalMapShader::BindShader(D3DGraphics& gfx, int indexCount)
{
	// 정점 입력 레이아웃을 바인딩 해줌.
