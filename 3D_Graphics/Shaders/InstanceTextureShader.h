...
public:
	...
	void Bind(D3DGraphics& gfx, int vertexCount, int indexCount, int instanceCount, XMMATRIX world, XMMATRIX view, XMMATRIX projection, ID3D11ShaderResourceView* texture);
...
private:
	...
	void BindShaders(D3DGraphics& gfx, int vertexCount, int indexCount, int instanceCount);
