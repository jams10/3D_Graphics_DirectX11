...
void TextureShader::Initialize(D3DGraphics& gfx)
{
	InitializeShaders(gfx, L"Shaders/TextureVS.cso", L"Shaders/TexturePS.cso");
}

void TextureShader::Bind(D3DGraphics& gfx, int indexCount, XMMATRIX world, XMMATRIX view, XMMATRIX projection, ID3D11ShaderResourceView* texture)
{
	// 월드, 뷰, 투영 행렬 설정해줌.
...
void TextureShader::InitializeShaders(D3DGraphics& gfx, const std::wstring& vsFileName, const std::wstring& psFileName)
{
	INFOMAN(gfx);
...
void TextureShader::SetShaderParameters(D3DGraphics& gfx, XMMATRIX world, XMMATRIX view, XMMATRIX projection, ID3D11ShaderResourceView* texture)
{
...
void TextureShader::BindShaders(D3DGraphics& gfx, int indexCount)
{
	// 정점 입력 레이아웃을 바인딩 해줌.
