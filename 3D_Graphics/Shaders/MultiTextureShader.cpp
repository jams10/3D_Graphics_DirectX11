...
bool MultiTextureShader::SetShaderParameters(D3DGraphics& gfx, XMMATRIX world, XMMATRIX view, XMMATRIX projection, float Gamma, ID3D11ShaderResourceView** textureArray)
{
